...
export default defineEventHandler((event) => {
  ...
  // Return tasks where user is owner of folder, or member of project.
  // HINWEIS: `projects` hat KEINE owner_id-Spalte (Eigentümer liegt auf project_folders.owner_id).
